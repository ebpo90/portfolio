...
function my_excerpt_protected( $excerpt ) {
    if ( post_password_required() )
        $excerpt = '<em>[This is portfolio piece is private, if you did not received a password, you can request it by sending an email to mailto:eduardo@ebpo.com.br]</em>';
    return $excerpt;
}
...
function my_password_form() {
    ...
    ' . __( "This is portfolio piece is private, if you did not received a password, you can request it by sending an email to eduardo@ebpo.com.br. To view this protected post, enter the received password below:" ) . '
    <br><label for="' . $label . '">' . __( "Password:" ) . ' </label><input name="post_password" id="' . $label . '" type="password" size="20" maxlength="20" /><input type="submit" name="Submit" value="' . esc_attr__( "Submit" ) . '" />
    </form>
    ';
    return $o;
}
